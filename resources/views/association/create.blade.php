        ...
        <div class="w-full sm:max-w-lg mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
          ...
          <form method="POST" action="{{ route('association.store') }}">
              ...
              <div class="mt-4">
                  ...
                  <x-jet-input class="block mt-1 w-full" type="text" id=name name="name" :value="old('name')" placeholder="Nom de l'association" required autofocus />
              </div>

              <div class="mt-4">
                  <x-jet-label value="Description" />
                  <textarea class="form-input rounded-md shadow-sm mt-1" style="width: 100%" id="description" name="description" :value="old('description')" placeholder="Description de l'association">{{ old('description') }}</textarea>
              </div>
