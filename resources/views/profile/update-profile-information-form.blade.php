<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="telephone" type="tel" class="mt-1 block w-full" wire:model.defer="state.telephone" autocomplete="telephone" />
    ...
    <x-slot name="actions">
        ...
        <x-jet-button wire:loading.attr="disabled" class="bg-blue-600 hover:bg-blue-900" wire:target="photo">
            {{ __('Save') }}
        </x-jet-button>
    </x-slot>
</x-jet-form-section>
